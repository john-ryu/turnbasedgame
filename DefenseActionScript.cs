...
public class DefenseActionScript : MonoBehaviour
{
    ...
    public Sprite defense2;
    public Sprite defense4;
    public Sprite defense5;
    void Start()
    {
    ...
    void UpdateEnergySlots(int count){
        switch(count){
            ...
            case 1:
                ...
                intentSpriteRenderer.sprite = defense2;
                break;
            case 2:
                energySlot1Sprite.sprite = energyFull;
                ...
                energySlot3Sprite.sprite = energyEmpty;
                intentSpriteRenderer.color = new Color(1f,1f,1f,1f);
                intentSpriteRenderer.sprite = defense4;
                break;
            case 3:
                energySlot1Sprite.sprite = energyFull;
                energySlot2Sprite.sprite = energyFull;
                ...
                intentSpriteRenderer.color = new Color(1f,1f,1f,1f);
                intentSpriteRenderer.sprite = defense5;
                break;
            default: //more than 3
                energySlot1Sprite.sprite = energyFull;
                energySlot2Sprite.sprite = energyFull;
